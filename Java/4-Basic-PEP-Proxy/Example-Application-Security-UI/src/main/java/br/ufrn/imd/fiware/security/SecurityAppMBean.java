...
public class SecurityAppMBean implements Serializable {
    ...
    private static final String URL_SERVICE_1 = "http://" + Config.PROXY_ADDRESS + "/Example-Application-Security-REST/securityapp/service1";
    private static final String URL_SERVICE_2 = "http://" + Config.PROXY_ADDRESS + "/Example-Application-Security-REST/securityapp/service2";
