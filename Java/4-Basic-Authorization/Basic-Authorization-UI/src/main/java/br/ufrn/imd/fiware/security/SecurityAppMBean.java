...
public class SecurityAppMBean implements Serializable {
	...
	private static final long serialVersionUID = 1L;
        ...
        private static final String URL_SERVICE_1 = Config.PROXY_ADDRESS + Config.APPLICATION_REST + "/securityapp/service1";
	private static final String URL_SERVICE_2 = Config.PROXY_ADDRESS + Config.APPLICATION_REST + "/securityapp/service2";
...
//                        resultHelloWorld = strJson;
			...
			resultHelloWorld = "Operation needs authorization!";
		}
	}
	...
	public void greeting() {
		try {
			...
			resultGreeting = "Operation needs authorization!";
		}
	}
	...
	public void listNames() {
		try {
			...
			resultListNames = "Operation needs authorization!";
		}
	}
	...
	public void addName() {
		try {
			...
			resultAddName = "Operation needs authorization!";
		}
	}
